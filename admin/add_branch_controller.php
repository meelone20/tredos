            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <h5><i class="fa fa-plus-square">&nbsp;&nbsp;</i> <b>Add Branch Head / Controller</b></h5>
      ...
      <!-- Add Branch Controller Form Starts -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="row" style="float: right; padding-right: 15px; ">
                        ...
                        <button type="submit" name="addBranch" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Staff</button>
                    </div>
                  </form>
...
<!-- Left DIV -->
        <div class="col-md-6 col-sm-12 col-xs-12" style="height: 100%;">
            <h5><i class="fa fa-location-arrow">&nbsp;&nbsp;</i><b>extra</b></h5>
            <div class="x_title"></div>
