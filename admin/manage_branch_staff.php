             ...
             <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
               ...
               <tbody>
                 <tr>
                   ...
                   <td>5421</td>
                   <td>
                     <a href='view_branch_staff.php' class='btn btn-xs btn-info'><i class='fa fa-file-text'></i> View Details</a>
                     <a href='edit_branch_staff.php?id=$staffID' class='btn btn-xs btn-primary'><i class='fa fa-pencil-square'></i> Edit</a>
                     <a href='delete_branch_staff.php?id=$staffID' class='btn btn-xs btn-danger delCheck' onclick='return confirmDel();'><i class='fa fa-trash'></i> Delete</a>
                   </td>
                 </tr>
