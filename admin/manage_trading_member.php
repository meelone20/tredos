  ...
  <body class="nav-md">
    ...
    <!--        <div class="page-title">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
           <div class="x_title">
             <h5><i class="fa fa-list">&nbsp;&nbsp;</i> <b>Manage Branch Staff </b></h5>
             ...
             <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
               ...
               <tbody>
                 <tr>
                   ...
                   <td>John Doe</td>
                   <td>Palpa</td>
                   <td>Butwal-10,Sukkhanagar</td>
                   <td>iBERRY</td>
                   <td>9821488749</td>
                   <td>Butwal, Amarpth</td>
                   <td>*********</td>
                   <td>
                     <a href='.php' class='btn btn-xs btn-info'><i class='fa fa-file-text'></i> View Details</a>
                     <a href='edit_trading_member.php?id=$staffID' class='btn btn-xs btn-primary'><i class='fa fa-pencil-square'></i> Edit</a>
                     <a href='.php?id=$staffID' class='btn btn-xs btn-danger delCheck' onclick='return confirmDel();'><i class='fa fa-trash'></i> Delete</a>
                   </td>
                 </tr>
