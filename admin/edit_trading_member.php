  ...
  <body class="nav-md">
    ...
    <!--        <div class="page-title">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <h5><i class="fa fa-user-plus">&nbsp;&nbsp;</i> <b> Register New Trading Member</b></h5>
    ...
    <form name="staff-form" onsubmit="return validateForm();" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <h5><i class="fa fa-user">&nbsp;&nbsp;</i> <b> Personal Details</b></h5>
                  <div class="x_title"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="date" format="" id="dob" name="dob" class="form-control col-md-7 col-xs-12" required/><br/>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">PP Size Photo *</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <img src="" height="100px" width="100px" alt="Trading member profile photo"><br/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Citizenship Copy *</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <img src="" height="200" width="200" alt="Trading member citizenship copy"><br/><br/>
                      </div>
                    </div>
...
<!-- Left DIV -->
        <div class="col-md-6 col-sm-12 col-xs-12" style="height: 100%;">
            <h5><i class="fa fa-building">&nbsp;&nbsp;</i><b>Store Details</b></h5>
            <div class="x_title"></div>

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">PAN No. *</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" id="" name="photo" class="form-control col-md-7 col-xs-12" required/><br/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" id="photo" name="photo" class="form-control col-md-7 col-xs-12" required/><br/>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Store Address *</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" id="photo" name="photo" class="form-control col-md-7 col-xs-12" required/><br/>
              </div>
            </div>
            ...
            <div class="row" style="float: right; padding-right: 15px; ">
                ...
                <button type="submit" name="addBranch" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;Register</button>
            </div>
    </div>
  </form>
